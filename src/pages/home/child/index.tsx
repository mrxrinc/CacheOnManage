...
export default ({ route }: any) => {
  ...
  return (
    <Layout>
      {childData && !isEmptyObject(childData) && (
        <>
          {!isChild ? (
            <Header
              dynamicTitle={`سلام ${childData.name}!`}
            ...
            >
              ...
              <View style={style.contentBox}>
                ...
                <View style={style.twinChildRow}>
                  ...
                  >
                    {formatNumber(childData.weeklyRemaining)}{" "}
                    <FormattedText style={style.currency} id={"home.rial"} />
                  </FormattedText>
                </View>
                ...
                <View style={style.twinChildRow}>
                  ...
                  <FormattedText
                    ...
                    fontFamily="Regular-FaNum"
                  >
                    {formatNumber(childData.weeklySpent)}{" "}
                    <FormattedText style={style.currency} id={"home.rial"} />
                  </FormattedText>
                </View>
              </View>
              ...
              >
                <View style={style.twinChildRow}>
                  ...
                  <FormattedText
                    ...
                    fontFamily="Regular-FaNum"
                  >
                    {formatNumber(childData.allowance.amount)}{" "}
                    <FormattedText style={style.currency} id={"home.rial"} />
                  </FormattedText>
                </View>
              </TouchableOpacity>
